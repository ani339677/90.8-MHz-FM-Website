document.addEventListener("DOMContentLoaded",
    function (){
        ...
        var event_carousel = function(){
            $ajaxUtils.sendGetRequest("/fm/data/events.json", function(eventsJson){
                $ajaxUtils.sendGetRequest("/fm/snippets/snippet_carousel.html", function(evenCarHtml){
                    var finalHtml="";
        ...
        var event_registration = function (){
            ...
            $ajaxUtils.sendGetRequest("/fm/data/events.json",
                function(resJson){
                    ...
                    $ajaxUtils.sendGetRequest("/fm/snippets/snippet_event_registration.html",
                        function(res){
                            var final_html=res;
        ...
        var events_lister = function(whichButton){
            ...
            $ajaxUtils.sendGetRequest("/fm/data/events.json",
                function(resJson){
                    var final_html="";
                    $ajaxUtils.sendGetRequest("/fm/snippets/snippet_event_display.html",
                        function(event_temp){
                            for (var i=0; i<resJson.length; i++){
        ...
        var eventsDisplay = function(){
            ...
            $ajaxUtils.sendGetRequest("/fm/snippets/snippet_events.html",
                function(res1){
        ...
        var contactDisplay = function(){
            $ajaxUtils.sendGetRequest("/fm/snippets/snippet_contact.html",
                function(res){
                    insertHtml("#snippet-adder",res);
                    fixing_navbar();
                    defining_links();
        ...
        var aboutDisplay = function(){
            $ajaxUtils.sendGetRequest("/fm/snippets/snippet_about.html",
                function(res){
                    insertHtml("#snippet-adder",res);
                    fixing_navbar();
                    defining_links();
                    ...
                    $ajaxUtils.sendGetRequest("/fm/data/senior_members.json", function(sMemJson){
                        $ajaxUtils.sendGetRequest("/fm/snippets/snippet_about_senior_team.html", function(sastHtml){
                            var final_html='';
                            for (var i=0; i<sMemJson.length; i++){
                                ...
                                if (sMemJson[i].developer==="true"){
                                    temp_sastHtml=insertProperty(temp_sastHtml,"developed_by",'<div class="developed-by">Developer</div>');
                    ...
                    $ajaxUtils.sendGetRequest("/fm/data/members.json", function(memJson){
                        var rjHtml="";
                        var evmHtml="";
                        var techHtml="";
                        $ajaxUtils.sendGetRequest("/fm/snippets/snippet_about_team.html", function(memHtml){
